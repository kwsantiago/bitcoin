...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-coinbasefreezestart=<time>", "Schedule the temporary coinbase spend freeze: coinbase outputs are unspendable at any depth from the block whose parent median-time-past reaches <time> until the RDTS expiry. Requires -rdtsexpiry. (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
