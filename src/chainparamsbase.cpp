...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-coinbasematurityrolling=<height>:<seconds>", "Schedule the rolling generation maturity: from <height> until the RDTS expiry, a coinbase output may only be spent once <seconds> have passed since the block that created it. Requires -rdtsexpiry. (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
