    ...
    if (fuzzed_data_provider.ConsumeBool()) {
        CallOneOf(
            ...
            [&] {
                ...
                if (Consensus::CheckTxInputs(transaction, state, coins_view_cache, fuzzed_data_provider.ConsumeIntegralInRange<int>(0, std::numeric_limits<int>::max()), tx_fee_out, CheckTxInputsRules::OutputSizeLimit, COINBASE_MATURITY, 0)) {
